...
VALUES ({0}, '{1}', '{4}', '{owner_id}', '{manager_id}', 50018, 50018,
        'G-20210630-0000002O', 1, 1, 0.00000, 0.3750000000, 1, '', '2021-06-30', '12:00~16:00', '', '', {2}, 1, 0, 1, '',
        '', '{3}', 2, 4, '2021-06-30 10:43:14', 704992510400925696, 'zhuzhiliang@banggood.com', 704992510400925696,
...
def inserInstorageRequestbwms(instorageRequestID, instorageRequestCode, instorageRequestboxID, instorageRequestboxCode,
                              instorageRequestBoxItemID, goodsID, shiftCode, ownerID, managerID, remark='手动添加',
                              box_max=False):
    ...
    if box_max is False:
        cursor.execute(
            inserSql_in_storage_request.format(instorageRequestID, instorageRequestCode, sr_type, remark, shiftCode,
                                               owner_id=ownerID, manager_id=managerID))
    else:
...
def inserInstorageRequestbwsp(instorageRequestID, instorageRequestCode, instorageRequestboxID, instorageRequestboxCode,
                              instorageRequestBoxItemID, goodsID, shiftCode,ownerID, managerID, remark='手动添加', box_max=False):
    ...
    if box_max is False:
        cursor1.execute(
            inserSql_in_storage_request.format(instorageRequestID, instorageRequestCode, sr_type, remark, shiftCode,owner_id=ownerID, manager_id=managerID))
    else:
        instorageRequestID = int(instorageRequestID) - 1
    cursor1.execute(
        inserSql_in_storage_request_box.format(instorageRequestboxID, instorageRequestID, instorageRequestboxCode))
...
if __name__ == "__main__":
    ...
    shiftCode = "SFT-O1-20210407-5008A"
    # shiftCode="PPL-20830-003"+code
    instorageRequestID = "959745893883" + code
    instorageRequestCode = "IHP202106301" + code
    instorageRequestboxID = "9597458942178" + code
    instorageRequestboxCode = "Fbox-20210632-" + code
    instorageRequestBoxItemID = "9597458945533" + code
    # goodsID = 567771061681397760   # PBUA04FD92A
    # goodsID = 687642759070490624   # PBUW000CDA5
    goodsID = 1494215690385027072  # PBU000412F9O
    # goodsID = 513238153801506816   # PBUA079D43
    managerID = "1418043601762304000"
    ownerID = "1418043601762304000"
    remark = '测试：货损重新上架'
    # 设置销售类型

    # 插入wms
    inserInstorageRequestbwms(instorageRequestID, instorageRequestCode, instorageRequestboxID, instorageRequestboxCode,
                              instorageRequestBoxItemID, goodsID, shiftCode, ownerID, managerID, remark, box_max)
