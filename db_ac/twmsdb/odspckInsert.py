...
VALUES ({0}, '{1}', '59196365780242',
        ...
        '新SFP产品  新款除草布3*100ft 针刺款', 3, 43.4900, 1, null, 'SKU831179', 'POA2792709', null, 95.00, 14.00, 14.00, '', null,
...
if __name__ == "__main__":
    ...
    pck='PCK121121061632266'
    order='A000272106150V66'
    # 天马
    process=1221
    # 递四方
    # process=1142
